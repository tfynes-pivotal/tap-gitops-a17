...
echo
echo Continue to create GitHub TAP GitOps Repo tap-gitops-a17
echo     https://github.com/tfynes-pivotal/tap-gitops-a17
echo
...
git add .
git commit -am "."
gh repo create tap-gitops-a17 --private
git remote add origin https://github.com/tfynes-pivotal/tap-gitops-a17
git branch -M main
